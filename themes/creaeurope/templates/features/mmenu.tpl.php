  ...
  <ul>
    <?php foreach ($blocks as $k => $block): ?>
        ...
        <li class="mmenu-collapsed">
            ...
            <span class="mmenu-block-collapsed mmenu-block">
              <i class="<?php print $block['icon_class']; ?>"></i>
              <span class="mmenu-block-title">
            ...
            <?php if($block['wrap']) : ?>
            <ul>
              <li class="mmenu-block-wrap">
                <span><?php print $block['content']; ?></span>
                </li>
                </ul>
            <?php else : ?>
        ...
        <?php if (!empty($block['subject'])) : ?>
          <li class="mmenu-expanded">
            <span class="mmenu-block-expanded mmenu-block">
              <i class="mmenu-block-icon mmenu-block-icon-
                <?php print $block['module']; ?>-<?php print $block['delta']; ?>">
              </i>
              <span class="mmenu-block-title">
                <?php print $block['subject']; ?>
              </span>
